...
#ifndef _MY_MULTISET_
#define _MY_MULTISET_
...
public:
	...
	{
		pair<typename tree_type::iterator, bool> p = t.insert_equal(x);
	...
	friend bool operator==(const multiset<Key, Compare, Alloc>& x,
